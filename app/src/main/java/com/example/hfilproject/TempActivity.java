...
public class TempActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver uartStatusChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            if (action.equals(BLETemperatureService.ACTION_GATT_CONNECTED)) {
                ...
                Toast.makeText(TempActivity.this, R.string.temperature_service_not_found, Toast.LENGTH_SHORT).show();
    ...
    private void intentSearchDevices() {
        Intent newIntent = new Intent(TempActivity.this, DeviceListActivity.class);
